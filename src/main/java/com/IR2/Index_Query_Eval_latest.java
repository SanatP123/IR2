...
public class Index_Query_Eval_latest {
    ...
    private final static String LATimesLOC = "Assignment Two/latimes";
    private final static String FBISLoc = "Assignment Two/fbis";
    ...
    private static Similarity globalSimilarity = null;

    public static Similarity getGlobalSimilarity() {
        return globalSimilarity;
    }

    public static void setGlobalSimilarity(Similarity globalSimilarity) {
        Index_Query_Eval_latest.globalSimilarity = globalSimilarity;
    }
    ...
    public static void setGlobAnalyzer(Analyzer globAnalyzer) {
        Index_Query_Eval_latest.globAnalyzer = globAnalyzer;
    }

    /**
     * command : java -jar target/demo-1.2.jar -analyser 4 -score 6
     * -analyser
     * 1:StandardAnalyzer
    ...
    public static void main(String[] args)
        ...
        for (int i = 0; i < args.length; i++) {
            if ("-analyser".equals(args[i])) {
                ...
                switch (Integer.parseInt(args[i + 1])) {
                    case 1:
                        setGlobalSimilarity(new ClassicSimilarity());
                        break;
                    case 2:
                        setGlobalSimilarity(new BM25Similarity());
                        break;
                    case 3:
                        setGlobalSimilarity(new BooleanSimilarity());
                        break;
                    case 4:
                        setGlobalSimilarity(new LMDirichletSimilarity());
                        break;
                    case 5:
                        setGlobalSimilarity(new AxiomaticF2EXP());
                        break;
                    case 6:
                        setGlobalSimilarity(
    ...
    public static void deleteINDEX() throws IOException {
        ...
        if (indexFile.exists()) {
            // System.out.println("Deleting pre-existing Index");
    ...
    private static boolean deleteFolder(File folder) {
        ...
        if (folder.isDirectory()) {
            // Get an array of all the files and subdirectories in the folder
    ...
    public static void Index_LA() throws IOException, SAXException, ParserConfigurationException {
        ...
        File files[] = new File(LATimesLOC)
                .listFiles();
        assert files != null;
        for (File file : files) {
    ...
    public static void Query() throws IOException {
        ...
        isearcher.setSimilarity(getGlobalSimilarity());
    ...
    public static void Eval() throws IOException, InterruptedException {
        ...
        String command = trec_eval;
        String argument1 = qrelLoc;
        String argument2 = outputfn;
    ...
    private static void Index_FR94() throws IOException, ParserConfigurationException, SAXException {
        ...
        System.out.println("Index Complete FR94");
    }
