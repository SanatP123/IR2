...
public class Index_Query_Eval_final {
    ...
    public static void Index_LA() throws IOException, SAXException, ParserConfigurationException {
        ...
        //
        File files[] = new File("Assignment Two/latimes")
                .listFiles();
        assert files != null;
        for (File file : files) {
    ...
    public static void Index_FBIS() throws IOException, SAXException, ParserConfigurationException {
        ...
        //
        File files[] = new File("Assignment Two/fbis")
                .listFiles();
        assert files != null;
        for (File file : files) {
    ...
    public static void Eval() throws IOException, InterruptedException {
        ...
        String argument1 = "qrels.assignment2.part1";


        String argument2 = "result";
    ...
    public static void Index_FT() throws IOException {
        ...
        File folder = new File("Assignment Two/ft");
    ...
    private static void Index_FR94() throws IOException, ParserConfigurationException, SAXException {
        //Change Path
        File files[] = new File("Assignment Two/fr94").listFiles();
        ...
        System.out.println("Indexing Complete FR94");
    }
